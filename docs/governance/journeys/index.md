...
詳細については、クラウド導入フレームワークの [Azure 仮想データセンター](/azure/architecture/vdc)に関するセクションを参照してください。
...
> [標準的なガバナンス ガイド](./standard-enterprise/index.md)
>
> [複雑な企業向けのガバナンス ガイド](./complex-enterprise/index.md)
