...
ログ記録とレポートを決めると、ログ データを格納する方法と、IT スタッフに操作の正常性を通知する監視およびレポート ツールを構造化する方法が決まります。 ここでは、[クラウド ネイティブ パターン](../../../decision-guides/log-and-report/index.md#cloud-native)** のログ記録とレポートが推奨されます。
...
> [セキュリティ ベースライン規範の改善](./security-baseline-evolution.md)
