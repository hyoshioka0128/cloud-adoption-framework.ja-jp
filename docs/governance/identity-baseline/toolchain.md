...
|サポートされる従来のプロトコルのブロック|[はい](/azure/active-directory/conditional-access/howto-baseline-protect-legacy-auth)|[はい](/azure/active-directory/conditional-access/howto-baseline-protect-legacy-auth)|[はい](/windows-server/identity/ad-fs/operations/access-control-policies-w2k12)|
