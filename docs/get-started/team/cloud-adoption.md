...
自分がメンバーとして属している導入チームの種類に応じて、次の 2 つの取り組みのいずれかを開始します。

- 作業を開始しましょう。ワークロードをクラウドに移行する
- 作業を開始しましょう。新しい製品またはサービスを構築する

これらのファースト ステップ ガイドには、さまざまなレベルの説明責任および実行責任と共に、さまざまなチーム向けのガイダンスが記載されています。 これらのガイドを使用して、自分のチームが取り組みのその他の部分にどのように適合するかを理解します。 また、これらを使用して、会社全体から得られると予想されるサポートのレベルを把握します。
