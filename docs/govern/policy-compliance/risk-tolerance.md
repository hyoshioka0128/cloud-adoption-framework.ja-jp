...
- **予算管理:** クラウドではコスト モデルが変わります。 この変更により、コスト超過や売却済商品の原価 (COGS) の増加、特に直接の要因となる運営費用に関連するリスクが生じる可能性があります。 ビジネス チームが IT チームと密接に連携すると、さまざまな事業単位、プログラム、またはプロジェクトによって消費されるコストとサービスに関して透明性を高めることができます。 [Cost Management の規範](../cost-management/index.md)には、ビジネス チームと IT チームがこの話題について連携可能な方法の例が示されています。
