...
> [!NOTE]
> このガイドでは、クラウド導入フレームワークでのイノベーションのガイダンスにおける開始点を提供します。 また、これは Azure クイック スタート センターでも利用できます。 Azure クイック スタート センターへのリンクについては、この記事の後半にあるヒントを参照してください。
