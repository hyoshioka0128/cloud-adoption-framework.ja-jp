...
- **再ホスト:** お客様は、多くの場合、移行を、現在の状態構成ですべての資産をクラウドにレプリケートする "*リフト アンド シフト*" 動作と同等と考えます。 その結果、IT ポートフォリオ内の誤差がほとんどなくなります。 このアプローチは、既存のデータセンターの資産を廃止する最速の方法でもあります。
