...
- **例:** ある会社は 100 年以上にわたって書籍の販売を行ってきました。 この会社の従業員が、コンテンツを電子的に配信できることに気付きました。 その従業員は、書店で販売でき、同じ書籍を直接ダウンロードできるデバイスを作成して、新しい書籍の売上を _x_ ドル伸ばしています。
