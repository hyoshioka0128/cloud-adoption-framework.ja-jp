...
[戦略手法](../../strategy/index.md)では、[動機](../../strategy/motivations.md)と[ビジネス成果](../../strategy/business-outcomes/index.md)を詳しく調べます。 これらのプラクティスでは、顧客への影響をテストするための一連のメトリックが用意されています。 イノベーションが成功すると、通常、戦略目標に沿った結果が得られます。
...
合意したメトリックを文書化し、それらの影響を頻繁に追跡しますが、数回の反復でこれらのメトリックのいずれかの結果が得られるとは考えないでください。 関係するパーティ間での期待値の設定および調整の詳細については、「[イテレーションに対するコミットメント](./index.md#commitment-to-iteration)」を参照してください。
