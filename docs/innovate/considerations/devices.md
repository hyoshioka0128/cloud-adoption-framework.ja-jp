...
ms.locfileid: "86191197"
---
# <a name="ambient-experiences-interact-with-devices"></a>アンビエント エクスペリエンス:デバイスの操作

「[顧客の共感を構築する](./build.md)」では、真のイノベーションの 3 つのテストについて説明しました。顧客のニーズを解決し、顧客にリピーターになってもらい、顧客コーホート基盤全体にわたって拡大します。 仮説の各テストでは、採用のアプローチでの取り組みと反復が必要になります。 この記事では、"_アンビエント エクスペリエンス_" によってその労力を減らすための高度なアプローチについて説明します。 アプリケーションではなく、デバイスとやり取りすることによって、顧客はそのソリューションに最初に目を向ける可能性が高まります。
