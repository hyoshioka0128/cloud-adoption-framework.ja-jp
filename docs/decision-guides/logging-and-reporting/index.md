...
- 外部サービスとの統合および監視とアラート サービスの自動化のための [REST API](/azure/azure-monitor/essentials/rest-api-walkthrough)。
- 多くの人気のあるサード パーティ ベンダーとの[統合](/azure/azure-monitor/partners)。
