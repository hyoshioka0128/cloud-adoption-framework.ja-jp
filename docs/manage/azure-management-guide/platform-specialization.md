...
- **拡張性:** 負荷の増加に対応するために、共通プラットフォーム資産をスケーリングする
- **可用性:** アップタイムの可能性を向上させることにより、ビジネスの中断を減らす
- **回復性:** 復旧時間を改善して中断期間を短縮する
- **セキュリティ:** 外部の脅威からアプリケーションとデータを保護する
