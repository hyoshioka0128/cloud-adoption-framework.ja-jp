...
クラウド導入チームとクラウド戦略チームは協力して、この小さなワークロードを分析できます。 このコラボレーションによって、定性分析の条件を作成してテストするための制御された機会が生まれます。 より少人数であれば、影響を受けるユーザーを調査したり、1 週間以内に詳細な定性分析を完了したりする機会が得られます。 定性分析の一般的な要因については、「[合理化の 5 R](./5-rs-of-rationalization.md)」で具体的な合理化目標を参照してください。
