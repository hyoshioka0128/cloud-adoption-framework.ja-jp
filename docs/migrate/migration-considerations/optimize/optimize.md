...
Microsoft の子会社である Cloudyn によってライセンスされる [Azure Cost Management](/azure/cost-management/overview) は、透明性と正確性をもってクラウド支出を管理します。 このサービスは、クラウド コストの監視、ベンチマーク、割り当て、および最適化を行います。
