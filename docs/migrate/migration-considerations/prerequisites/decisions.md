...
- **移行。** 運用の成果の例には、差し迫ったビジネス上の動機、導入の速度、またはコスト削減があります。 これらの成果は、IT または運用モデルでの推移的な変更からビジネス価値を向上させようとする努力の中心に存在します。 クラウド導入フレームワークの移行方法論は、移行に焦点を絞ったビジネス成果に大きな重点を置いています。
