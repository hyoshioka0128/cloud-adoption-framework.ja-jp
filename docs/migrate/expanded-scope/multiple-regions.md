...
- 類似した環境の複数のインスタンスをデプロイする場合、環境ファクトリで整合性を作成し、ガバナンスを改善して、デプロイを加速させることができます。 [大企業のガバナンス体験](../../governance/journeys/complex-enterprise/index.md)では、複数のリージョンにわたる規模の環境ファクトリを作成するアプローチを確立しています。
