...
- **[計画](../business-strategy/index.md):** 技術的な実装と明確なビジネス目標が合致していれば、技術的な意思決定にかかわらず、複数のクラウド実装の取り組みにまたがって成功を測定および調整することは非常に容易になります。
...
- **[運用](../operating-model/index.md):** 導入中および導入後のアクティビティをガイドする管理可能な運用モデルを定義します。
  ...
  - **[ガバナンス](../governance/index.md):** ポリシー、プロセス、およびクラウド ベースのガバナンス ツールを通じて軽減された具体的なリスクに合わせて、会社のポリシーを調整します。
  - **[管理](../operations/index.md):** 最新のクラウド ファーストの運用ツールを使用して、安全でコスト効率に優れたプロセスを通じてクラウド ベースのソリューションを運用できるように、IT 業務を拡張します。
