...
- **大規模 (高可用性) デプロイ** は、2000 人を超える同時ユーザーをサポートします。 このデプロイで使用されているのは、Azure Files、MySQL (16 個の仮想コア)、Redis キャッシュです。Elasticsearch などの他のオプションはありません。
